...
>
> Последняя ревизия: 2026-07-28 · Спецификация: v1.1
...
| Редстоун / асинхронное освещение / сущности / полная поэтапная физика | ❌ Ещё не начато |
...
- 📋 Граф-редстоун (DDG)
- 📋 Асинхронное освещение (flood-fill по ячейкам) — пока действует фолбэк `FullBright`
